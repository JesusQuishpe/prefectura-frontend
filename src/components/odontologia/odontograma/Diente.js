...
const Diente = ({ tooth, onClick, reverse, toothDetail }) => {
  //console.log(tooth);
  const { optionSelected, updateTooth } = useContext(OdontogramaContext)

  const initialParams = {
    top_side: toothDetail ? toothDetail.top_side : "",
    right_side: toothDetail ? toothDetail.right_side : "",
    left_side: toothDetail ? toothDetail.left_side : "",
    bottom_side: toothDetail ? toothDetail.bottom_side : "",
    center_side: toothDetail ? toothDetail.center_side : "",
    symbo_path: toothDetail ? toothDetail.symbo_path : "",
    symb_id: toothDetail ? toothDetail.symb_id : "",
    tooth_id: tooth.id,
    id: toothDetail ? toothDetail.id : null
  }
          ...
          >
            {
              params.symbo_path ?
                <div className='d-flex align-items-center justify-content-center_side w-100 h-100'>
                  <img src={require("assets/svg/" + params.symbo_path)} width={"30px"} height={"30px"} />
                </div>
                : ""
            }
          </div>
