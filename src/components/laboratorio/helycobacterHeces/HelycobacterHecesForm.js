...
export const HelycobacterHecesForm = ({ dataModal, closeModal, actualizarPendientes, doctores, openToast, closeToast }) => {
    var initialForm = {
    ...
    return (
        <div>
            ...
            >
                {
                    ({ errors, touched }) => (
                        <Form id='form-helycobacter-heces'>
                            <h3>Helycobacter Heces</h3>
                            <Row>
                                <FormReact.Group>
                                    <FormReact.Label>
                                        Doctor:
