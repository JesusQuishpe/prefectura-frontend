...
export const ModalCoprologia = ({ closeModal, dataModal, actualizarPendientes, setShowLoader, doctores,openToast,closeToast }) => {
    return (
        <div>
            <Modal show={dataModal?.id_tipo === 2} onHide={closeModal} dialogClassName='modal-25w' size='lg'>
