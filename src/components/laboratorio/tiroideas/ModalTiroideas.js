...
export const ModalTiroideas = ({ closeModal, dataModal, actualizarPendientes, setShowLoader, doctores, openToast, closeToast }) => {

    return (
        <div>
            <Modal show={dataModal?.id_tipo === 10} onHide={closeModal} dialogClassName='modal-25w' size='lg'>
